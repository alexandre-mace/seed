        ...
        {item && (
          <table className="table table-responsive table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row">initiatedProjects</th>
                <td>{this.renderLinks('projects', item['initiatedProjects'])}</td>
              </tr>
              <tr>
                <th scope="row">supportedProjects</th>
                <td>{this.renderLinks('projects', item['supportedProjects'])}</td>
              </tr>
            </tbody>
          </table>
        )}
